...
const UserMessage = ({
  ...
  <DropdownMenu>
    <DropdownMenuTrigger className="flex gap-2 justify-end max-w-1/2">
    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <footer className="row-start-3 w-full flex gap-6 flex-wrap items-center justify-end">
        <AlertDialog>
          ...
          <AlertDialogContent className="bg-white h-[95%]">
            <AlertDialogHeader className="flex w-full justify-center">
              <AlertDialogCancel className=" w-6 h-6 p-1 self-end text-gray-600 border-none shadow-none">
                <XIcon size={16} />
              </AlertDialogCancel>
            ...
            <Separator />
            <AlertDialogFooter className="flex flex-col items-center h-center">
              <input
                ref={inputRef}
                type="text"
